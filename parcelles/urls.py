...
urlpatterns = [
    ...
    path('multi-step-eval_local/', views.multi_step_eval_view_local, name='multi_step_eval_local'),
    ...
    path('generate_multi_step_report_local/', views.generate_multi_step_report_local, name='generate_multi_step_report_local'),
